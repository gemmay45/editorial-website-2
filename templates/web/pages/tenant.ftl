				...
				<#if contentModel.recommended_o?? && contentModel.recommended_o.item??>
                    <h4>Recommended</h4>
                              ...
                              <#list recTenants as recTenant>
                                <@crafter.span $model=contentModel.recommended_o.item>${recTenant.title}</@crafter.span><br/>
                                <@crafter.span $model=contentModel.recommended_o.item>${recTenant.key}</@crafter.span><br/>
                              </#list>
