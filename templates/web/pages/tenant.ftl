				...
				<#if contentModel.recommended_o?? && contentModel.recommended_o.item??>
                    <h4>Recommended</h4>
                              ...
                              <#list recTenants as recTenant>
                                <@crafter.span $model=contentModel.recommended_o.item[0]>${recTenant.title}</@crafter.span><br/>
                                <@crafter.span $model=contentModel.recommended_o.item[0]>${recTenant.key}</@crafter.span><br/>
                              </#list>
